...
/**
 * クラスはデータとその処理を一つにまとめたもの
 * public：をつけないと外から使えない
 * 関数もメンバにできる。これもメンバ関数という*/
...
void show(const Student& student){
    cout << "名前：　"  << student.name << endl << "国語：" << student.scoreJapanese << "点" << ",数学" << student.scoreMath << "点" << ",英語" << student.socreEnglish << "点" << endl;
};
...
int main(){
    ...
    int size = sizeof student / sizeof *studennt;
...
void Student::Show() {
    cout << "名前：" << name << endl << "国語:" <<  socreJapanese << "数学:" << scoreMath << "英語：" << scoreEnglish << "点" << endl;
}
